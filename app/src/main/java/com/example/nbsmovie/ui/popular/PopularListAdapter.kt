...
import kotlinx.android.synthetic.main.item_grid_popular.view.*
...
class PopularListAdapter(
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): RecyclerView.ViewHolder {
        ...
        if (viewType == MOVIE_VIEW_TYPE) {
            view = layoutInflater.inflate(R.layout.item_grid_popular, parent, false)
    ...
    class MovieItemViewHolder (view: View) : RecyclerView.ViewHolder(view) {
        fun bind(movie: Movie?,context: Context) {
            itemView.tv_popular_title.text = movie?.title
            itemView.tv_popular_releasedate.text =  movie?.releaseDate

            val moviePosterURL = POSTER_BASE_URL + movie?.posterPath
            Glide.with(itemView.context)
                .load(moviePosterURL)
                .into(itemView.iv_popular_poster);
